...
export default function page() {
    ...
    useEffect(() => {
        const getData = async () => {
            ...
            // const channelData = await fetch(`/api/youtube?type=channel&id${videoId}`)
    ...
    return currentVideo ? (
        ...
        <div className='text-gray-900 p-6 lg:flex gap-5 max-w-2xl mx-auto lg:max-w-full dark:bg-black dark:text-gray-200'>
            <div>
        <section className='w-full max-w-3xl mx-auto'>
            ...
            <div className='flex flex-col sm:flex-row justify-between gap-3'>
                ...
                <div className='flex items-center gap-3 sm:gap-5'>
                    ...
                    <div className='hidden sm:flex items-center p-2 sm:p-3 rounded-full border border-gray-300 bg-transparent gap-2 sm:gap-3'>
                        <button className='flex items-center gap-2'>
                            <svg width="24" height="24" viewBox="0 0 122.88 106.16">
                    ...
                    <button className='p-2 sm:p-3 rounded-full border border-gray-300 bg-gray-100 flex items-center gap-2'>
                        <svg width="24" height="24" viewBox="0 0 122.88 98.86">
                    ...
                    <button className='bg-gray-200 rounded-full p-2 sm:p-3 block'>
                        <img src='/assets/more.svg' width={20} className='dark:invert' />
                    </button>
                </div>
            </div>

            <div className='p-3 mt-3 rounded-xl bg-gray-100 border border-gray-200'>
        ...
        <div className='text-gray-900 p-6 lg:flex gap-5 max-w-2xl mx-auto lg:max-w-full  dark:bg-black'>
        <div>
            <section className='max-w-2xl mx-auto w-full'>
                ...
                <div className='flex justify-between'>
                    ...
                    <div className='flex items-center gap-5'>
                        ...
                        <button className='bg-gray-200 rounded-full p-3 block lg:hidden'></button>
                    </div>

                </div>

                <div className='rounded-xl bg-gray-100 h-50 dark:bg-gray-700'></div>
